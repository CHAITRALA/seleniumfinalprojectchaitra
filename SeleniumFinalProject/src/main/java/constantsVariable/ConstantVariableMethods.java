package constantsVariable;

public class ConstantVariableMethods
{
	...
	public static final String excel_path=System.getProperty("user.dir")+"\\src\\test\\resources\\ExcelRead\\project Excel.xlsx";
}
